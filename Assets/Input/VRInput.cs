...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input/VRInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @VRInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""HMD"",
            ""id"": ""618e562d-47ca-4ffd-ab22-d9f6478b966a"",
            ""actions"": [
                {
                    ""name"": ""Rotation"",
                    ""type"": ""Value"",
                    ""id"": ""24052bef-8a0d-475b-be35-9b18d0200f8c"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""576fd912-9a1b-4a21-aaa2-e2e33404df40"",
    ...
    ~@VRInput()
    {
        UnityEngine.Debug.Assert(!m_HMD.enabled, "This will cause a leak and performance issues, VRInput.HMD.Disable() has not been called.");
    }
    ...
    public struct HMDActions
    {
        ...
        /// </summary>
        public HMDActions(@VRInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
